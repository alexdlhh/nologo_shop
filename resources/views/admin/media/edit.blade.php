...
<div class="container_admin">
    ...
    <div class="leftf">
        <a href="/admin/media_list/" class="btn-floating btn-large waves-effect waves-light"><img src="/icons/rfeg_ico_cancelar.svg" width="18"></a>
        ...
        <a href="/media/{{$coleccion_id}}" id="" class="btn-floating btn-large waves-effect waves-light"><img src="/icons/rfeg_ico_liveview.svg" width="18"></a>
    </div>
</div>
@endsection
