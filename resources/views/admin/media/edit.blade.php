...
<div class="container_admin">
    ...
    <div class="leftf">
        <a href="/admin/media_list/" class="btn-floating btn-large waves-effect waves-light red"><i class="material-icons">cancel</i></a>
        ...
        <a href="/media/{{$coleccion_id}}" id="" class="btn-floating btn-large waves-effect waves-light blue"><i class="material-icons">screen_share</i></a>
    </div>
</div>
@endsection
