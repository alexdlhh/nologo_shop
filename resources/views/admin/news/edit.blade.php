...
<div class="container_admin">
                            ...
                            <div class="galery_viewer">
                                @if(!empty($admin['albumnew']))
                                    ...
                                    <div class="col s3">
                                        ...
                                        <a href="#!" data-id="{{$image->id}}" class="delalbum btn-floating btn-small waves-effect waves-light"><img src="/icons/rfeg_ico_borrar.svg" width="28"></a>
                                    </div>
                                    @endforeach
                                @endif
                            </div>
    ...
    <div class="leftf">
        <a href="/admin/news" class="btn-floating btn-large waves-effect waves-light"><img src="/icons/rfeg_ico_cancelar.svg" width="28"></a>
        ...
        <a href="/noticias/todo/todo/{{ $admin['news']->getPermantlink() }}" id="" class="btn-floating btn-large waves-effect waves-light"><img src="/icons/rfeg_ico_liveview.svg" width="28"></a>
    </div>
</div>
@endsection
