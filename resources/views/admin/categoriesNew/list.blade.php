                            ...
                            <table class="striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$category->name}}</td>
                                        <td>
                                            <a href="javascript:void(0)" data-name="{{$category->name}}" data-id="{{$category->id}}" class="edit btn-floating btn-small waves-effect waves-light"><img src="/icons/rfeg_ico_editar.svg" width="28"></a>
                                            <a href="javascript:void(0)" data-id="{{$category->id}}" class="del btn-floating btn-small waves-effect waves-light"><img src="/icons/rfeg_ico_borrar.svg" width="28"></a>
                                        </td>
                                    @endforeach
                                </tbody>
                            </table> 
