                                    ...
                                    <table class="">
                                        ...
                                        @foreach($admin['normativas'] as $normativa)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#see_pdf" class="modal-trigger see_pdf" data-file="{{$normativa->getDownloadPdf()}}"><img src="/rfeg_ico_pdfview.png" width="24"></a>
                                                </td>
                                                <td>
                                                    ...
                                                    <a href="javascript:;" data-id="{{$normativa->getId()}}" class="btn-floating btn-small waves-effect waves-light modal-trigger delete_normativa"><img src="/icons/rfeg_ico_borrar.svg" width="24"></a>
                                                </td>
                                            </tr>
                                            @endif
                                        @endforeach
...
<div class="leftf">
    <a href="/normativa" class="btn-floating btn-large waves-effect waves-light"><img src="/icons/rfeg_ico_liveview.svg" width="24"></a>
</div>
