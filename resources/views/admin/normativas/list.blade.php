                                    ...
                                    <table class="striped">
                                        ...
                                        <tr>
                                            ...
                                            <th><a href="#add_normativa" 
                                                ...
                                                class="btn-floating btn-small waves-effect waves-light modal-trigger add_normativa"><img src="/icons/rfeg_ico_guardar.svg" width="28"></a></th>
                                        </tr>
                                        </thead>
                                        ...
                                        @foreach($admin['normativas'] as $normativa)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#see_pdf" class="modal-trigger see_pdf" data-file="{{$normativa->getDownloadPdf()}}"><img src="/icons/rfeg_ico_pdfview.svg" width="28"></a>
                                                </td>
                                                <td>
                                                    <a href="#edit_normativa" data-id="{{$normativa->getId()}}" data-documento="{{$normativa->getDocumento()}}" data-download-pdf="{{$normativa->getDownloadPdf()}}" data-active="{{$normativa->getActive()}}" data-rfeg-title="{{$normativa->getType()}}" class="btn-floating btn-small waves-effect waves-light modal-trigger edit_normativa"><img src="/icons/rfeg_ico_editar.svg" width="28"></a>
                                                    <a href="javascript:;" data-id="{{$normativa->getId()}}" class="btn-floating btn-small waves-effect waves-light modal-trigger delete_normativa"><img src="/icons/rfeg_ico_borrar.svg" width="28"></a>
                                                </td>
                                            </tr>
                                            @endif
                                        @endforeach
...
<div class="leftf">
    <a href="/normativa" class="btn-floating btn-large waves-effect waves-light"><img src="/icons/rfeg_ico_liveview.svg" width="28"></a>
</div>
