                            ...
                            <table class="striped">
                                ...
                                @foreach($admin['banners'] as $banner)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/admin/banner/edit/{{$banner->getId()}}" class="btn-floating btn-small waves-effect waves-light orange"><img src="/icons/rfeg_ico_editar.svg" width="18"></a>
                                            <a href="javascript:void(0);" data-id="{{$banner->getId()}}" class="del btn-floating btn-small waves-effect waves-light red"><img src="/icons/rfeg_ico_borrar.svg" width="18"></a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
...
<div class="leftf">
    <a href="/admin/banner/create" class="btn-floating btn-large waves-effect waves-light red"><img src="/icons/rfeg_ico_guardar.svg" width="18"></a>
