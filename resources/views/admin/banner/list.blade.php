                            ...
                            <table class="striped">
                                ...
                                @foreach($admin['banners'] as $banner)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/admin/banner/edit/{{$banner->getId()}}" class="btn-floating btn-small waves-effect waves-light orange"><i class="material-icons">edit</i></a>
                                            <a href="javascript:void(0);" data-id="{{$banner->getId()}}" class="del btn-floating btn-small waves-effect waves-light red"><i class="material-icons">delete</i></a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
...
<div class="leftf">
    <a href="/admin/banner/create" class="btn-floating btn-large waves-effect waves-light red"><i class="material-icons">add</i></a>
