...
<div class="container_admin">
                            ...
                            <table class="striped">
                                ...
                                @foreach($admin['albums'] as $album)
                                    <tr>
                                        <td>{{ $album->getName() }}</td>
                                        <td>
                                            <a href="/admin/album/edit/{{$album->getId()}}" class="btn-floating btn-small waves-effect waves-light"><img src="/icons/rfeg_ico_editar.svg" width="24"></a>
                                            <a href="javascript:void(0);" data-id="{{$album->getId()}}" class="del btn-floating btn-small waves-effect waves-light"><img src="/icons/rfeg_ico_borrar.svg" width="24"></a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
    ...
    <div class="leftf">
        <a href="/admin/album/create" class="btn-floating btn-large waves-effect waves-light"><img src="/icons/rfeg_ico_guardar.svg" width="24"></a>
