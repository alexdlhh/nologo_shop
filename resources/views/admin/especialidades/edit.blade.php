                                        ...
                                        <div class="row doc_ doc_{{$resultados['data']->id}}">
                                            @foreach($resultados['documentos'] as $documentos)
                                                <div class="col s2">
                                                    ...
                                                    <div class="actions">
                                                        <a href="#seePdf" data-file="{{$documentos->documento}}" class="modal-trigger btn-floating btn-small waves-effect waves-light see_pdf" ><img src="/rfeg_ico_pdfview.png" width="24"></a>
