                            ...
                            <div class="row">
                                <div class="col s12 card_admin">
                                    <h4>{{$resultados['data']->name}}                        
                                        <a href="#edit_resultado" data-json="{{json_encode($resultados['data'])}}" class="btn-floating btn-small waves-effect waves-light blue modal-trigger edit_resultados_btn"><img src="/icons/rfeg_ico_editar.svg" width="18"></a>
                                        <a href="javascript:;" data-id="{{$resultados['data']->id}}" class="btn-floating btn-small waves-effect waves-light red del_resultados"><img src="/icons/rfeg_ico_borrar.svg" width="18"></a>
                                    </h4>
                                    <table class="striped">
                                        <thead>
                                            <tr>
                                        ...
                                        <div class="row">
                                            @foreach($resultados['documentos'] as $documentos)
                                                <div class="col s2">
                                                    ...
                                                    <div class="actions">
                                                        <a href="#seePdf" data-file="{{$documentos->documento}}" class="modal-trigger btn-floating btn-small waves-effect waves-light orange see_pdf" ><img src="/icons/rfeg_ico_pdfview.svg" width="18"></a>
                                                        ...
                                                        <a href="javascript:;" data-id="{{$documentos->id}}" class="btn-floating btn-small waves-effect waves-light red del_documentos"><img src="/icons/rfeg_ico_borrar.svg" width="18"></a>
                                                    </div>
                                                </div>
                                            @endforeach
                                        </div>
...
<div class="leftf">
    <a href="/especialidades/{{$admin['especialidades']->getAlias()}}/" id="" class="btn-floating btn-large waves-effect waves-light blue"><img src="/icons/rfeg_ico_liveview.svg" width="18"></a>
</div>
<!-- Modal Structure -->
