                            ...
                            <div class="row">
                                <div class="col s12 card_admin">
                                    <h4>{{$resultados['data']->name}}                        
                                        <a href="#edit_resultado" data-json="{{json_encode($resultados['data'])}}" class="btn-floating btn-small waves-effect waves-light blue modal-trigger edit_resultados_btn"><i class="material-icons">edit</i></a>
                                        <a href="javascript:;" data-id="{{$resultados['data']->id}}" class="btn-floating btn-small waves-effect waves-light red del_resultados"><i class="material-icons">delete</i></a>
                                    </h4>
                                    <table class="striped">
                                        <thead>
                                            <tr>
                                        ...
                                        <div class="row">
                                            @foreach($resultados['documentos'] as $documentos)
                                                <div class="col s2">
                                                    ...
                                                    <div class="actions">
                                                        <a href="#seePdf" data-file="{{$documentos->documento}}" class="modal-trigger btn-floating btn-small waves-effect waves-light orange see_pdf" ><i class="material-icons">remove_red_eye</i></a>
                                                        <a href="#editResultadoFile" data-id="{{$resultados['data']->id}}" data-json="{{json_encode($documentos)}}" target="_blank" class="modal-trigger btn-floating btn-small waves-effect waves-light edit_document" ><i class="material-icons">create</i></a>
                                                        <a href="javascript:;" data-id="{{$documentos->id}}" class="btn-floating btn-small waves-effect waves-light red del_documentos"><i class="material-icons">delete</i></a>
                                                    </div>
                                                </div>
                                            @endforeach
                                        </div>
