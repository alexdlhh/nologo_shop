                        ...
                        <div class="row">
                            ...
                            <div class="col s12 card_admin">
                                <div class="row" id="tabla">   
                                    <h4>{{$rfeg_title->name}}                     
                                        <a href="#edit_rfeg_title" data-id="{{$rfeg_title->getId()}}" data-type="{{$rfeg_title->getType()}}" data-name="{{$rfeg_title->name}}" class="btn-floating btn-small waves-effect waves-light modal-trigger edit_rfeg_title_btn"><img src="/icons/rfeg_ico_editar.svg" width="28"></a>
                                    </h4>
                                    <table class="striped">
                                        <thead>
                                        <tr>
                                            ...
                                            <th><a href="#add_course" 
                                                ...
                                                class="btn-floating btn-small waves-effect waves-light modal-trigger add_course"><img src="/icons/rfeg_ico_guardar.svg" width="28"></a></th>
                                        </tr>
                                        </thead>
                                        ...
                                        @foreach($admin['courses'] as $course)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#see_pdf" class="modal-trigger see_pdf" data-file="{{$course->getConvocatoriaPdf()}}"><img src="/icons/rfeg_ico_pdfview.svg" width="28"></a>
                                                </td>
                                                <td>
                                                    <a href="#see_pdf" class="modal-trigger see_pdf" data-file="{{$course->getInscripcionPdf()}}"><img src="/icons/rfeg_ico_pdfview.svg" width="28"></a>
                                                </td>
                                                <td>
                                                    <a href="#see_pdf" class="modal-trigger see_pdf" data-file="{{$course->getFormulariosPdf()}}"><img src="/icons/rfeg_ico_pdfview.svg" width="28"></a>
                                                </td>
                                                <td>
                                                    <a href="#edit_course" 
                                                    ...
                                                    class="btn-floating btn-small waves-effect waves-light edit_curso_btn orange"><img src="/icons/rfeg_ico_editar.svg" width="28"></a>
                                                    <a href="javascript:void(0);" data-id="{{$course->getId()}}" class="del btn-floating btn-small waves-effect waves-light"><img src="/icons/rfeg_ico_borrar.svg" width="28"></a>
                                                </td>
                                            </tr>
                                            @endif
                                        @endforeach
...
<div class="leftf">
    <a href="/schools" id="" class="btn-floating btn-large waves-effect waves-light"><img src="/icons/rfeg_ico_liveview.svg" width="28"></a>
</div>
