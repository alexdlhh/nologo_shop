                                    ...
                                    <table class="striped">
                                        ...
                                        @foreach($admin['courses'] as $course)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#see_pdf" class="modal-trigger see_pdf" data-file="{{$course->getConvocatoriaPdf()}}"><img src="/icons/rfeg_ico_pdfview.svg" width="18"></a>
                                                </td>
                                                <td>
                                                    <a href="#see_pdf" class="modal-trigger see_pdf" data-file="{{$course->getInscripcionPdf()}}"><img src="/icons/rfeg_ico_pdfview.svg" width="18"></a>
                                                </td>
                                                <td>
                                                    <a href="#see_pdf" class="modal-trigger see_pdf" data-file="{{$course->getFormulariosPdf()}}"><img src="/icons/rfeg_ico_pdfview.svg" width="18"></a>
                                                </td>
                                                <td>
                                                    <a href="#edit_course" 
