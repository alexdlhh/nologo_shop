        ...
        <div class="container_table">
            ...
            <div class="row content_table">
                ...
                <div class="col s2">
                    ...
                    <a href="{{$courses->getConvocatoriaPdf()}}" download class=""><img src="/icons/rfeg_ico_pdfdownload.svg" width="18"></a>
                </div>                
                <div class="col s2">
                    <a href="#modal1" data-url="{{$courses->getInscripcionPdf()}}" class="openpdf modal-trigger"><img src="/icon-pdf.png" alt=""></a>
                    <a href="{{$courses->getInscripcionPdf()}}" download class=""><img src="/icons/rfeg_ico_pdfdownload.svg" width="18"></a>
                </div>                
                <div class="col s2">
                    <a href="#modal1" data-url="{{$courses->getFormulariosPdf()}}" class="openpdf modal-trigger"><img src="/icon-pdf.png" alt=""></a>
                    <a href="{{$courses->getFormulariosPdf()}}" download class=""><img src="/icons/rfeg_ico_pdfdownload.svg" width="18"></a>
                </div>
